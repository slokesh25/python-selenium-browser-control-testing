...
# driver.find_element("id","twotabsearchtextbox").send_keys('apple 17 pro max')
# sleep(3)

# driver.find_element("id","nav-search-submit-button").click()
# sleep(3)

# driver.find_element("xpath","//span[contains(text(),'iPhone 17 Pro Max 256 GB:')]").click()
# sleep(3)
...
driver.find_element("xpath","//span[contains(@class,'b3wTlE')]").click()
sleep(3)

driver.find_element("class name","nw1UBF v1zwn2").send_keys('samsung s24 ultra')
sleep(3)

driver.find_element("")

# driver.find_element("xpath","").send_keys('samsung s24 ultra')
# sleep(3)
